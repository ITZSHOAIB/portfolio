...
>
  <div class="flex h-full flex-col justify-between">
    <div>
      ...
      >
        <a class="font-semibold tracking-tight" href="#top">{profile.domain}</a>
        <span
          class="rounded-full border border-[#27272a] px-2.5 py-1 text-xs font-bold text-[#a1a1aa]"
        >
          Dark only
        </span>
      </div>
      ...
      >
        ...
        <div class="mt-7 flex items-center gap-4 border-t border-[#27272a] pt-7">
          <img
        ...
        <div class="mt-8 space-y-7 border-t border-[#27272a] pt-8">
          <div>
            <p class="text-xs font-bold uppercase tracking-[0.14em] text-[#d4d4d8]">
              Focus
            </p>
            <p
          ...
          <div class="border-t border-[#27272a] pt-6">
            <p class="text-xs font-bold uppercase tracking-[0.14em] text-[#a1a1aa]">
              Background
            </p>
            <div class="mt-3 space-y-3 text-sm leading-7 text-[#a1a1aa]">
              <p>{profile.current}</p>
        ...
        <div class="mt-10 flex flex-wrap gap-3">
          <a
            class="inline-flex items-center gap-2 rounded-md bg-[#fafafa] px-4 py-3 text-sm font-bold text-[#000000] transition hover:bg-[#e4e4e7]"
            href="/resume.pdf"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <a
            class="inline-flex items-center gap-2 rounded-md border border-[#27272a] px-4 py-3 text-sm font-bold text-[#e4e4e7] transition hover:border-[#52525b] hover:bg-[#0a0a0a]"
            href="/resume.pdf"
            download
          >
        ...
        <div class="mt-6 flex flex-wrap gap-2 border-t border-[#27272a] pt-6">
          {#each profile.links as link}
            <a
              class="inline-flex min-h-9 items-center gap-2 rounded-md border border-[#27272a] bg-[#0a0a0a] px-2.5 text-xs font-medium text-[#e4e4e7] transition hover:border-[#52525b] hover:bg-[#111111]"
              href={link.href}
            ...
            >
              <IconMark
                ...
                label={link.label}
                fallback={link.label === "LinkedIn" ? "in" : undefined}
                fallbackColor={link.label === "LinkedIn" ? "#0A66C2" : undefined}
                brandColor={link.label !== "LinkedIn"}
                class={link.label === "GitHub" || link.label === "Twitter/X"
                  ? "size-3.5 rounded-sm bg-white p-0.5"
                  : "size-3.5"}
              />
